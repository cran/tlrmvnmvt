...
// mvt_internal
Rcpp::List mvt_internal(Eigen::VectorXd a, Eigen::VectorXd b, double nu, Eigen::MatrixXd covM, bool useLog2, int N);
RcppExport SEXP _tlrmvnmvt_mvt_internal(SEXP aSEXP, SEXP bSEXP, SEXP nuSEXP, SEXP covMSEXP, SEXP useLog2SEXP, SEXP NSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Eigen::VectorXd >::type a(aSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type useLog2(useLog2SEXP);
    Rcpp::traits::input_parameter< int >::type N(NSEXP);
    rcpp_result_gen = Rcpp::wrap(mvt_internal(a, b, nu, covM, useLog2, N));
    return rcpp_result_gen;
END_RCPP
}
// mvt_internal2
Rcpp::List mvt_internal2(Eigen::VectorXd a, Eigen::VectorXd b, double nu, Eigen::MatrixXd geom, int kernelType, Eigen::VectorXd para, double nugget, bool useLog2, int N);
RcppExport SEXP _tlrmvnmvt_mvt_internal2(SEXP aSEXP, SEXP bSEXP, SEXP nuSEXP, SEXP geomSEXP, SEXP kernelTypeSEXP, SEXP paraSEXP, SEXP nuggetSEXP, SEXP useLog2SEXP, SEXP NSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Eigen::VectorXd >::type a(aSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type useLog2(useLog2SEXP);
    Rcpp::traits::input_parameter< int >::type N(NSEXP);
    rcpp_result_gen = Rcpp::wrap(mvt_internal2(a, b, nu, geom, kernelType, para, nugget, useLog2, N));
    return rcpp_result_gen;
END_RCPP
}
// tlrmvt_internal
Rcpp::List tlrmvt_internal(Eigen::VectorXd a, Eigen::VectorXd b, double nu, Eigen::MatrixXd covM, bool useLog2, int m, double epsl, int N);
RcppExport SEXP _tlrmvnmvt_tlrmvt_internal(SEXP aSEXP, SEXP bSEXP, SEXP nuSEXP, SEXP covMSEXP, SEXP useLog2SEXP, SEXP mSEXP, SEXP epslSEXP, SEXP NSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Eigen::VectorXd >::type a(aSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type epsl(epslSEXP);
    Rcpp::traits::input_parameter< int >::type N(NSEXP);
    rcpp_result_gen = Rcpp::wrap(tlrmvt_internal(a, b, nu, covM, useLog2, m, epsl, N));
    return rcpp_result_gen;
END_RCPP
}
// tlrmvt_internal2
Rcpp::List tlrmvt_internal2(Eigen::VectorXd a, Eigen::VectorXd b, double nu, Eigen::MatrixXd geom, int kernelType, Eigen::VectorXd para, double nugget, bool useLog2, int m, double epsl, int N);
RcppExport SEXP _tlrmvnmvt_tlrmvt_internal2(SEXP aSEXP, SEXP bSEXP, SEXP nuSEXP, SEXP geomSEXP, SEXP kernelTypeSEXP, SEXP paraSEXP, SEXP nuggetSEXP, SEXP useLog2SEXP, SEXP mSEXP, SEXP epslSEXP, SEXP NSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Eigen::VectorXd >::type a(aSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type epsl(epslSEXP);
    Rcpp::traits::input_parameter< int >::type N(NSEXP);
    rcpp_result_gen = Rcpp::wrap(tlrmvt_internal2(a, b, nu, geom, kernelType, para, nugget, useLog2, m, epsl, N));
    return rcpp_result_gen;
END_RCPP
}
// zorder
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_tlrmvnmvt_mvt_internal", (DL_FUNC) &_tlrmvnmvt_mvt_internal, 6},
    {"_tlrmvnmvt_mvt_internal2", (DL_FUNC) &_tlrmvnmvt_mvt_internal2, 9},
    {"_tlrmvnmvt_tlrmvt_internal", (DL_FUNC) &_tlrmvnmvt_tlrmvt_internal, 8},
    {"_tlrmvnmvt_tlrmvt_internal2", (DL_FUNC) &_tlrmvnmvt_tlrmvt_internal2, 11},
